...
ACarbuncleMenu::ACarbuncleMenu()
{
	...
	HeadRenderer->SetPivot(PivotType::TopCenter);
	...
	UBodyRenderer->SetPivot(PivotType::TopCenter);
	...
	DBodyRenderer->SetPivot(PivotType::TopCenter);
	...
	LHandRenderer->SetPivot(PivotType::TopRight);
	...
	RHandRenderer->SetPivot(PivotType::TopLeft);
	...
	LegRenderer->SetPivot(PivotType::TopCenter);
	...
	LArrowRenderer->SetPivot(PivotType::MiddleRight);
	...
	RArrowRenderer->SetPivot(PivotType::MiddleLeft);
	...
	JewelRenderer->SetPivot(PivotType::TopCenter);
